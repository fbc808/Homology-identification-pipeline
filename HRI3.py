...
def extraction(genome, coordinates, flank_nucleotide_number):
    ...
    query = open("Query.fa", "a")               # Open file to append lines to, (will create file, if not found).
    ...
    for x in coor:                              # For every row (circle) in coordinates file.
        ...
        if position in genome:                  # If chromosome name is in the genome file.
            ...
            query.write(joined_title)           # Append title to query file.
            query.write("\n")                   # Append newline to query file.
            query.write(up)                     # Append upstream sequence nucleotides to query file.
            query.write("\n")                   # Append newline to query file.
            subject.write(joined_title)         # Append title to subject file.
            subject.write("\n")                 # Append newline to subject file.
            subject.write(down)                 # Append downstream sequence nucleotides to subject file.
            subject.write("\n")                 # Append newline to subject file.
        else:                                   # If chromosome name is not in the genome file.
            joined = "\t".join(x)               # Join list of strings to make a single string.
            remaining.write(joined)             # Append string as line to remaining file.
            remaining.write("\n")               # Append newline to remaining file.
